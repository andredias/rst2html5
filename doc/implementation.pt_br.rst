...
Docutils, doctree, rst2pseudoxml e NodeVisitor
==============================================

O docutils_ é um conjunto de ferramentas para tradução de documentação em restructuredText_ (rst)
...
que então é passado ao conversor (``Writer``) para ser transformado na saída formatada desejada::
                ...
                +----------+
   doctree ---->| Tradutor |----> output
                +----------+

Doctree
-------

O doctree_ é a representação hierárquica dos elementos que compõem o documento rst em uma estrutura de árvore.
O comando ``rst2pseudoxml`` gera uma representação textual da *doctree* que é muito útil
para visualizar os elementos identificados e o aninhamento de um documento rst.
...
A travessia da árvore é coordenada pelo método :func:`docutils.nodes.Node.walkabout`
...
para todos os tipos de nós existentes.
